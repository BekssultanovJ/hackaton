...
class LoginSerialiser(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if email and password:
            ...
            raise serializers.ValidationError('Поле Email и пароль обязательны')
        attrs['user'] = user
        return attrs
...
class CreateNewPasswordSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if password != password_confirm:
            raise serializers.ValidationError('парол и не совпадают')
        return attrs
...
class ChangePasswordSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if pass_ != pass_confirm:
            raise serializers.ValidationError('неверное подтверждение нового пароля')
        return attrs
